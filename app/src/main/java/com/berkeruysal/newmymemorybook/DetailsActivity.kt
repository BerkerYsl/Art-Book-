...
import com.berkeruysal.newmymemorybook.databinding.ActivityDetailsBinding
...
class DetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (info.equals("new")) {
            ...
            val selectedImageBackground = BitmapFactory.decodeResource(applicationContext.resources,R.drawable.icon)
